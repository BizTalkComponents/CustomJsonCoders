...
namespace BizTalkComponents.PipelineComponents.CustomJsonCoders
{
    ...
    {
        public string Name { get { return "Custom JSON Encoder"; } }
        public string Version { get { return "1.0"; } }
        public string Description { get { return "Allows you to customize and your JSON output as an array by removing the main object and the name of the array."; } }
